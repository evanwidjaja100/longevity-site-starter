 ...
 */
?>
<!-- wp:group --><div class="wp-block-group"><!-- wp:heading --><h2 class="wp-block-heading">Corrections remain visible</h2><!-- /wp:heading --><!-- wp:paragraph --><p>Report a possible factual error or material product change through the documented corrections process.</p><!-- /wp:paragraph --><!-- wp:paragraph --><p><a href="<?php echo esc_url( \Longevity\Core\Routes::public_page_url( 'corrections' ) ); ?>">Review the corrections process</a></p><!-- /wp:paragraph --></div><!-- /wp:group -->
